...
lane的功能
1. 每一个fiber创建的时候其lanes，childLanes字段都被初始化为NoLanes   
2.  创建更新   
*/
// 
export const TotalLanes = 31;

export const NoLanes: Lanes = /*                        */ 0b0000000000000000000000000000000;//二进制数字0
export const NoLane: Lane = /*                          */ 0b0000000000000000000000000000000;

export const SyncHydrationLane: Lane = /*               */ 0b0000000000000000000000000000001;
export const SyncLane: Lane = /*                        */ 0b0000000000000000000000000000010;   //同步的Lane  这个标识应该代表着所有调用这个Lane的函数，都会变成同步执行
